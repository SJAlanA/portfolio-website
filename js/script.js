document.addEventListener('DOMContentLoaded', () => {
    const projects = [
        { title: 'Road Accident Detection', technology: 'Python, CNN, OpenCV',description: 'Developed a deep learning model achieving 89.73% AUC, reducing false positives by 10% in real-time accident detection. Implemented Resnet 18 which is a Convolution Neural Network (CNN) for feature extraction and trained a Multilayer Perceptron (MLP) for precise accident classification. Enhanced road safety with an AI-driven mobile app for alerts.' },
        { title: 'Yoga Pose Detection and Correction', technology: 'Python, Machine Learning, OpenCV',description: 'Yoga is a new way to look at the disciplines of our lives, such as physical, mental, and spiritual practices. It is injurious to our health to do yoga poses without an instructor. So here we are going to represent a proposed model for yoga pose detection using a machine-learning algorithm to identify and detect the yoga pose form. Our website works for 8 yoga poses. The input is preprocessed in the form of an image, the object is detected, and the core of the human body is identified using the media pipe and Open CV library. For training and testing data, we use CSV files downloaded from Kaggle. We use Traditional Machine Learning models such as XG Boost and Transfer Learning models such as VGG16 for training and testing. The results of both the models have been compared and the system with the best accuracy score has been employed.' },
    ...
    const certifications = [
        ...
        'Network Essentials, Cisco, Oct 2023',
        'Cybersecurity Essentials, Cisco, Nov 2023',
